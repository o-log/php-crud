        ...
        */
        ...
        foreach ($props_arr as $prop_obj){
            ...
            if (array_key_exists($prop_obj->getName(), $context_arr_fields)) {
                ...
                unset($context_arr_fields[$prop_obj->getName()]); // оставшиеся поля контекста уйдут в невидимые
            }
            ...
            echo '<label class="col-sm-4 text-right control-label" for="' . $prop_obj->getName() . '">' . $editor_title . '</label>';

            echo '<div class="col-sm-8">';
            echo \OLOG\CRUD\Widgets::renderEditorFieldWithWidget($prop_obj->getName(), $obj, $value);
