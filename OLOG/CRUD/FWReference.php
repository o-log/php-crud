...
class FWReference implements FWInterface
{
    ...
    public function html($obj)
    {
        ...
        foreach ($referenced_obj_ids_arr as $id){
            $obj = CInternalObjectLoader::createAndLoadObject($referenced_class_name, $id);
            $options_arr[$id] = CInternalFieldsAccess::getObjectFieldValue($obj, $referenced_class_title_field);
        }
