...
class TWDelete implements TWInterface
{
    ...
    public function __construct($button_text = '', $button_class_str = 'btn btn-sm btn-outline-secondary fa fa-remove', $redirect_after_delete_url = ''){
    ...
    public function html($obj){
        ...
        $o .='<input type="hidden" name="' . self::FIELD_OBJECT_ID . '" value="' . HTML::attr(CInternalFieldsAccess::getObjId($obj)) . '">';
