...
class TFDateRange implements TFInterface
{
    ...
    public function getHtml()
    {
        ...
        foreach ([$this->getPlaceholderStart() => $this->getStartFilterId(), $this->getPlaceholderEnd() =>$this->getEndFilterId()] as $key => $filterId)
        {

            $html .= '<input type="hidden" id="' . $filterId . '_input" name="' . $filterId . '"  data-field="' . $filterId . '_date" >
                <div class="input-group date" id="' . $filterId . '">
                <input id="' . $filterId . '_date" type="text" class="form-control" value="" placeholder="' . $key . '">
